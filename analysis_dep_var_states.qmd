...
1.  Meaningful employment
    ...
    3.  Meaningful employment - in Northwest Minnesota, but not in the same EDR as their high school
    4.  Meaningful employment - in Minnesota, but not in Northwest Minnesota
...
grads <- read_csv("Data/SLEDS/Masters//After analysis/Master-final-after-mca.csv") %>%
  select(PersonID)
...
3.  Has meaningful employment in Northwest Minnesota, but not in same EDR as high school.
4.  Has meaningful employment in Minnesota, but not in Northwest Minnesota.
...
3.  Meaningful emp SW: means they have worked 1,000 hours or more for one employer located in Northwest Minnesota, but not in the same EDR or county as their high school.
4.  Meaningful emp MN - means they have worked 1,000 hours or more for one employer located in Minnesota, but not in Northwest Minnesota.
...
1.  The percentage of individuals with meaningful employment in Northwest Minnesota peaks about 6 years after college with nearly 25% of graduates working 1,000 hours or more that year for a single employer in the Northwest Minnesota.
2.  At 6 years after graduating, over 40% of the graduates have meaningful employment in Minnesota.
3.  Graduates not reaching the meaningful employment threshold in Minnesota hovers around 15% after the first year of graduating high school.
4.  Over 40% of graduates disappear from my dataset about 10 years after graduating. This means they are not going to post-secondary in the United States and do not have a Minnesota employment record.
