...
Alright, lets see what this dataset looks like. I will first import the entire dataset, then clean it up, and then merge it with the master / Northwest graduate dataset.
